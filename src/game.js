...
import PauseMenu from './UI/PauseMenu.js';
    ...
    var config = {
	    ...
	    scene:[MainMenu,Planta1, Planta2, Planta3, Planta4, Planta4_2, Planta5, MJ_Plataformas, MJ_Basuras, MJ_Nave, UiScene, PauseMenu ], // Metodos que queremos en nuestros scripts
        scale:{
