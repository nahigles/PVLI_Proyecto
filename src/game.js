...
import MJ_Carpetas from './Minijuegos/mj_Carpetas.js';
    ...
    var config = {
	    ...
	    scene:[MainMenu,Planta1, Planta2, Planta3, Planta4, Planta4_2, Planta5, MJ_Plataformas, MJ_Basuras, MJ_Carpetas, MJ_Nave, PauseMenuMJPlataforma,PauseMenuMJBasura, UiScene, PauseMenuPlanta1, PauseMenuPlanta2 ], // Metodos que queremos en nuestros scripts
        scale:{
