...
export default class PauseMenu extends Phaser.Scene {
    ...
    create(data){
		...
		new Button(this,300, 105, 'resumeButton', ()=>{this.scene.resume(this.level); this.scene.get(this.level).music(true);},  ()=>{this.scene.stop();},  ()=>{}, ()=>{}, this.ButtonSoundd);
        //Controles
        new Button(this, 300, 200, 'controlsButton', ()=>{ this.controlsMenu.setVisible(true); },   ()=>{ this.backButton.setVisible(true);}, ()=>{}, ()=>{}, this.ButtonSoundd);
        // BotonSalir
        new Button(this, 300, 300, 'exitButton', ()=>{this.goHome();}, ()=>{this.scene.pause();},()=>{}, ()=>{}, this.ButtonSoundd);

        //menu controles
        this.controlsMenu = this.add.image(0,0,'controlsMenu').setOrigin(0,0).setVisible(false);
        //boton volver menu pausa
        this.backButton = new Button(this, 35, 20, 'backButton', ()=>{this.controlsMenu.setVisible(false);}, ()=>{ this.backButton.setVisible(false);},()=>{}, ()=>{}, this.ButtonSoundd);
